...
def add_common_parser_opts(parser):
    ...
    parser.add_argument('--attack-method', type=str, choices=["none", "critic", "random", "action", "sarsa", "sarsa+action", "advpolicy", "action+imit", "uniform"], help='adversarial attack methods.')
